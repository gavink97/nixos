return {
    {
        ...
        config = function()
            ...
            lspconfig.tailwindcss.setup({
                ...
                capabilities = capabilities,
                filetypes = {
                    "templ", "astro", "javascript", "typescript", "react",
                    "typescriptreact"
                },
            ...
            for _, server in ipairs({
                "bashls", "biome", "cssls", "dockerls",
                "docker_compose_language_service", "glsl_analyzer", "gopls",
                "jsonls", "rust_analyzer", "pylsp", "marksman", "nil_ls",
                "sourcekit", "sqls", "vimls", "yamlls", "zls"
            }) do
